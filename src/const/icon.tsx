...
const ResetSvg = () => (
    <svg height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 1024 1024" fill="currentColor" >
        <path fill="currentColor"
...
const ResetIcon = (props: Partial<CustomIconComponentProps>) => <Icon component={ResetSvg} {...props} />
